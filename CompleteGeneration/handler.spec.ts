...
import {ReportGeneratedEventPublisher} from "../GenerateReport/application/report-generated-event.publisher";
...
describe("CompleteGeneration handler", () => {
    ...
    it("should complete generated report", async () => {
        ...
        const publisher: jest.Mocked<ReportGeneratedEventPublisher> = {
            publish: jest.fn()
        };

        const useCase = new CompleteGenerationUseCase(repository, publisher);
