...
export const paymentsContainer: Container = database.container(config.paymentsContainerName);
export const customersContainer: Container = database.container(config.customersContainerName);