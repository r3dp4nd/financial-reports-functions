# Contratos detallados de artefactos `.migration/`

## Cuándo cargar

Carga esta referencia solo cuando necesites crear, actualizar o auditar la estructura detallada de un artefacto `.migration/`.
